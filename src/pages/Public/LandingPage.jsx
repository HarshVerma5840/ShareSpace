...
const LandingFeatureCard = React.memo(function LandingFeatureCard({ title, description, tone }) {
...
const MarketingFeatureTile = React.memo(function MarketingFeatureTile({ icon: Icon, title, description, tone, index }) {
...
const DashboardPreviewCard = React.memo(function DashboardPreviewCard({ title, eyebrow, accent, content, index }) {
...
function LandingPage() {
  return (
    <div className="min-h-screen bg-[#060a0f] text-white overflow-hidden">
      <main className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pt-24 pb-32">
        <LandingSectionHeader title="Welcome to ShareSpace" subtitle="The future of parking" />
        <div className="mt-12">
          <AuthScreen />
        </div>
      </main>
